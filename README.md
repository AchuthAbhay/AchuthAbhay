...
<h3 align="center">AI/ML Engineer • GenAI • RAG • Backend Development</h3>

<p align="left"> 
  <img src="https://komarev.com/ghpvc/?username=AchuthAbhay&label=Profile%20views&color=0e75b6&style=flat" alt="AchuthAbhay" /> 
</p>
...
- 🤖 Building practical AI systems in **GenAI, RAG, LLM evaluation, meeting intelligence, and workflow automation**
- 🧠 Ex **Generative AI Intern at Tata Communications**, where I evaluated speech and LLM systems, guardrails, and model safety
- 💻 Worked as a **Python Developer Intern at Infosys Springboard**, building Flask-based REST APIs and analytics dashboards
- 📚 Interested in **AI agents, LangGraph, MLOps, system design, and production-ready AI applications**
- 📝 Published research on **automated meeting documentation using ASR, diarization, and summarization**
- 🔭 Currently focused on building AI products that solve real-world problems
...
- Backend projects with real-world impact
...
- Better evaluation strategies for LLM-based systems
- Building stronger, portfolio-worthy projects
...
- **AI/ML:** PyTorch, Scikit-learn, RAG, Embeddings, NLP, LLM Integration
- **Backend:** Flask, FastAPI, REST APIs, WebSockets
- **Databases:** PostgreSQL, MongoDB, Qdrant, SQLite
- **Tools:** Git, Docker, AWS EC2, Streamlit, AssemblyAI, Groq
- **Core CS:** Data Structures & Algorithms, OOP, SDLC
